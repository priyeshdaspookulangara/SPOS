...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20241016052537_AddCrmEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.InteractionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Opportunity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.PosTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.PosTransactionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Relationship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ChildCustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.PosTransactionItem", b =>
                {
                    ...
                    b.HasOne("Core.Entities.PosTransaction", "PosTransaction")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Core.Entities.Relationship", b =>
                {
                    b.HasOne("Core.Entities.Customer", "ChildCustomer")
                        .WithMany("ParentRelationships")
                        .HasForeignKey("ChildCustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Core.Entities.Customer", "ParentCustomer")
